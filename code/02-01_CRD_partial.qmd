...
# d) EDA plots  
jitter helps to spread out the points horizontally if we have a lot of data
```{r n boxplot}
ggplot(crd_dfw, aes(y=yield_kgha, 
                    x=nrate_kgha,
                    color = nrate_kgha))+
  geom_boxplot()+
  geom_point()+
...
Type III doesn't care what is the order of the treatments in the model. However, for type I it matters, it changes the results depending on which order you have in the model. But, type III doesn't.
